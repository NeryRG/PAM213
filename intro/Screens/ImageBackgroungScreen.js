...
import { Text, StyleSheet, View, ImageBackground, Image, TouchableOpacity, StatusBar } from 'react-native'

const SPLASH_IMAGE = require('../assets/Recursos/SPLASH_IMAGE.png');
...
export default function ImageBackgroungScreen() {
    ...
    return(
        <ImageBackground source={MAIN_IMAGE} resizeMode='cover' imageStyle={styles.mainImageStyle} style={styles.mainBackground}>
            <StatusBar barStyle="light-content" backgroundColor='transparent' translucent/>
            <View style={styles.mainOverlay}>
                <Text style={styles.welcome}>Bienvenido a la app!</Text>
                <TouchableOpacity style={styles.button} onPress={() => alert('Boton presionado')}>
